...
public class RideCreateRequest {
    ...
    // Constructor
    public RideCreateRequest(String fromLocation, String toLocation, double fromLat, double fromLng,
                             double toLat, double toLng, int totalSeats, double farePerSeat,
                             String departureTime, String notes, String vehicleType, String vehicleNumber) {
